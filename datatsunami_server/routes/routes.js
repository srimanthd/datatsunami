...
router.get('/start_1', function(req, res, next) {
  ...
  if(cp_1 == null){
      cp_1 = spawn_1('python3',['../analytics/streaming_server.py']);
	  pid_1 = cp_1.pid;
	  status_1 = "Active"
...
router.post('/start_1', function(req, res, next) {
  ...
  if(cp_1 == null){
      cp_1 = spawn_1('python3',['../analytics/streaming_server.py',req.body.query]);
	  pid_1 = cp_1.pid;
	  status_1 = "Active"
      res.send({ status_1 : status_1, pid_1: pid_1 });
  }
...
router.get('/start_2', function(req, res, next) {
  ...
  var spawn_2 = cp.exec;
  if(cp_2 == null){
      cp_2 = spawn_2('spark-submit --master local[2] ../analytics/top_trends.py localhost 5053', function(error, stdout, stderr) {});
	  pid_2 = cp_2.pid+1;
      status_2 = "Active"
